...
const StockDashboard = () => {
  ...
  useEffect(() => {
    ...
    // Company Profile
    loadTradingViewScript('company-profile', 'https://s3.tradingview.com/external-embedding/embed-widget-symbol-profile.js', {
      width: '100%',
      height: '100%',
      colorTheme: 'dark',
      isTransparent: true,
  ...
  return (
    ...
    <header className="flex justify-between items-center px-8 py-4 bg-transparent shadow-sm">
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 max-w-6xl mx-auto w-full">
        ...
        <section id="company-profile" className="col-span-2 h-[390px]"></section>
